...
def utils_non_dominated(problems, main_algorithm, algorithms_to_compare):
    labels_algorithms = {'cmibaco': 'cMIBACO', 'cmibaco-base': 'cMIBACO$_{base}$',
                         'ibaco-hv-lns': 'IBACO$_{HV}$', 'ibaco-r2-lns': 'IBACO$_{R2}$',
    ...
    ranks_hv = get_table_mean(problems, 'non-evaluations-hv.csv', 'non-table-hv-n.tex', 'HV',
                              algorithms_to_compare=algorithms_to_compare, main_algorithm=main_algorithm)
    ranks_r2 = get_table_mean(problems, 'non-evaluations-r2.csv', 'non-table-r2-n.tex', 'R2',
                              algorithms_to_compare=algorithms_to_compare, main_algorithm=main_algorithm)
    ranks_es = get_table_mean(problems, 'non-evaluations-es.csv', 'non-table-es-n.tex', '$E_s$',
                              algorithms_to_compare=algorithms_to_compare, main_algorithm=main_algorithm)
    ...
    plot_general_table(problems, 'non-evaluations-hv.csv', 'total-evaluations-hv.pdf', algorithms=algorithms,
                       labels=labels_algorithms)
    plot_general_table(problems, 'non-evaluations-r2.csv', 'total-evaluations-r2.pdf', algorithms=algorithms,
                       labels=labels_algorithms)
    plot_general_table(problems, 'non-evaluations-es.csv', 'total-evaluations-es.pdf', algorithms=algorithms,
                       labels=labels_algorithms)
