...
if __name__ == '__main__':
    ...
    # Diagrama de cada indicador
    plot_difference_diagram_indicator_uvrp(problems, algorithms, 'lre-executions.csv', 'hv', 'lre-critic-diff-hv.pdf', labels_algorithms)
    plot_difference_diagram_indicator_uvrp(problems, algorithms, 'lre-executions.csv', 'es', 'lre-critic-diff-es.pdf', labels_algorithms)
    plot_difference_diagram_indicator_uvrp(problems, algorithms, 'lre-executions.csv', 'r2', 'lre-critic-diff-r2.pdf', labels_algorithms)
    # Diagrama general
    plot_general_diagram_uvrp(algorithms, labels_algorithms)


    algorithms = [main_algorithm] + other_algorithms

    # Tabla de promedio y desv
    ranks_hv = get_table_mean_uvrp(problems, 'lre-executions.csv', 'lre-table-hv.tex', 'hv', main_algorithm, other_algorithms)
    ranks_es = get_table_mean_uvrp(problems, 'lre-executions.csv', 'lre-table-es.tex', 'es', main_algorithm, other_algorithms)
    ranks_r2 = get_table_mean_uvrp(problems, 'lre-executions.csv', 'lre-table-r2.tex', 'r2', main_algorithm, other_algorithms)

    # Grafica de posiciones por algoritmo
    plot_ranks(ranks_hv, 'lre-ranks-hv.pdf', 'Performance rating indicator $HV$ in light robustness', labels_algorithms)
    plot_ranks(ranks_r2, 'lre-ranks-r2.pdf', 'Performance rating indicator $R2$ in light robustness', labels_algorithms)
    plot_ranks(ranks_es, 'lre-ranks-es.pdf', 'Performance rating indicator $E_s$ in light robustness', labels_algorithms)
